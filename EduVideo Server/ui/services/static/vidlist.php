    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container-fluid">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.html"><h1><img src="images/weblogo.png" style= "width:150px" alt="" /></h1></a>
        </div>
			...
			<div class="top-navigation">
				...
				<div class="drop-navigation drop-navigation">
				  <ul class="nav nav-sidebar"><br/>
					...
					<li><a href="#" class="cp-icon"><span class="glyphicon glyphicon-home glyphicon-blackboard" aria-hidden="true"></span>C++<span class="glyphicon glyphicon-menu-down" aria-hidden="true"></span></a></li>
					<ul class="cl-effect-1">
							<li><a href="movies.html">Introduction<span class="glyphicon glyphicon-menu-down" aria-hidden="true"></span></a></li>                                             
							<li><a href="movies.html">Basics<span class="glyphicon glyphicon-menu-down" aria-hidden="true"></span></a></li>
							<li><a href="movies.html">Concepts<span class="glyphicon glyphicon-menu-down" aria-hidden="true"></span></a></li>
							<li><a href="movies.html">Intermediate<span class="glyphicon glyphicon-menu-down" aria-hidden="true"></span></a></li>
							<li><a href="movies.html">Advanced<span class="glyphicon glyphicon-menu-down" aria-hidden="true"></span></a></li> 
						</ul>
						<!-- script-for-menu -->
						<script>
							$( "li a.cp-icon" ).click(function() {
							$( "ul.cl-effect-1" ).slideToggle( 300, function() {
							// Animation complete.
							});
							});
						</script>
					<li><a href="#" class="java-icon"><span class="glyphicon glyphicon-home glyphicon-hourglass" aria-hidden="true"></span>Java<span class="glyphicon glyphicon-menu-down" aria-hidden="true"></span></a></li>
					<ul class="cl-effect-2">
						...
						<!-- script-for-menu -->
						<script>
							$( "li a.java-icon" ).click(function() {
							$( "ul.cl-effect-2" ).slideToggle( 300, function() {
							// Animation complete.
							});
							});
						</script>
					<li><a href="#" class="web1"><span class="glyphicon glyphicon-film" aria-hidden="true"></span>WebTech Part1<span class="glyphicon glyphicon-menu-down" aria-hidden="true"></span></a></li>
						...
						<!-- script-for-menu -->
						<script>
							$( "li a.web1" ).click(function() {
							$( "ul.cl-effect-3" ).slideToggle( 300, function() {
							// Animation complete.
							});
							});
						</script>
					<li><a href="#" class="web2"><span class="glyphicon glyphicon-film glyphicon-king" aria-hidden="true"></span>WebTech Part2<span class="glyphicon glyphicon-menu-down" aria-hidden="true"></span></a></li>
						...
						<!-- script-for-menu -->
						<script>
							$( "li a.web2" ).click(function() {
							$( "ul.cl-effect-4" ).slideToggle( 300, function() {
							// Animation complete.
							});
							});
						</script>
					<li><a href="#" class="chash-icon"><span class="glyphicon glyphicon-music" aria-hidden="true"></span>C#<span class="glyphicon glyphicon-menu-down" aria-hidden="true"></span></a></li>
					<ul class="cl-effect-5">
						...
						<!-- script-for-menu -->
						<script>
							$( "li a.chash-icon" ).click(function() {
							$( "ul.cl-effect-5" ).slideToggle( 300, function() {
							// Animation complete.
							});
							});
						</script>
					<li><a href="#" class="sql-icon"><span class="glyphicon glyphicon-envelope" aria-hidden="true"></span>SQL-Algorithms<span class="glyphicon glyphicon-menu-down" aria-hidden="true"></span></a></li>
					<ul class="cl-effect-6">
						...
						<!-- script-for-menu -->
						<script>
							$( "li a.sql-icon" ).click(function() {
							$( "ul.cl-effect-6" ).slideToggle( 300, function() {
							// Animation complete.
							});
							});
						</script>
